/* =========================================================
   ...
   FEATURES
   • Country code / ISO compatibility
   • Flag
   • Country name
   • Calling code
...
/* =========================================================
   NORMALIZE COUNTRY RECORDS
   ---------------------------------------------------------
   Adds compatibility fields used by different modules.
   ========================================================= */
...
MARKETPLACE_COUNTRIES.forEach(
    ...
    function(country) {
        ...
        if (
            !MARKETPLACE_COUNTRY_MAP.has(
                country.code
            )
        ) {

            MARKETPLACE_COUNTRY_MAP.set(
                country.code,
                country
            );
...
const MARKETPLACE_COUNTRY_LIST =
    Array.from(
        MARKETPLACE_COUNTRY_MAP.values()
    );
...
/* =========================================================
   KEEP ORIGINAL PUBLIC NAME
   ========================================================= */

MARKETPLACE_COUNTRIES.length = 0;


MARKETPLACE_COUNTRY_LIST.forEach(

    function(country) {

        MARKETPLACE_COUNTRIES.push(
            country
        );
...
function marketplaceCountryByCode(
    code
) {
...
function marketplaceCountryByName(
    name
) {
...
window.ALON_MARKETPLACE_COUNTRIES = {
    ...
    count:
        function() {
            ...
            return MARKETPLACE_COUNTRIES.length;
